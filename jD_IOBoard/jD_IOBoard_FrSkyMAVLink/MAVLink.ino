...
//OK          
        ...
        case MAVLINK_MSG_ID_GPS_RAW_INT:
          { 
            iob_lat = mavlink_msg_gps_raw_int_get_lat(&msg) / 100000.0f;
            if (iob_lat < 0) {
              iob_lat_dir = 'S';
            ...
            iob_lon = mavlink_msg_gps_raw_int_get_lon(&msg) / 100000.0f;
            if (iob_lon < 0) {
              iob_lon_dir = 'W';
        ...
        case MAVLINK_MSG_ID_VFR_HUD:
          {
            ...
            iob_climb = mavlink_msg_vfr_hud_get_climb(&msg);  // m/s
          }
          break;
//OK         
...
//OK
        case MAVLINK_MSG_ID_ATTITUDE:
          {
            iob_pitch = ToDeg(mavlink_msg_attitude_get_pitch(&msg)); // rad
